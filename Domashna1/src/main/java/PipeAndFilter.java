...
public class PipeAndFilter {
    public static void main(String[] args) throws IOException {
        ...
        File restaurantsFile=new File("C:\\Users\\andre\\Downloads\\DIANS_Domasna1\\DIANS_Domasna1\\Domashna1\\src\\main\\resources\\filtered_restaurants.csv");
        File barsFile=new File("C:\\Users\\andre\\Downloads\\DIANS_Domasna1\\DIANS_Domasna1\\Domashna1\\src\\main\\resources\\filtered_bars.csv");
        File cafesFile=new File("C:\\Users\\andre\\Downloads\\DIANS_Domasna1\\DIANS_Domasna1\\Domashna1\\src\\main\\resources\\filtered_cafes.csv");
        ...
        BufferedReader restaurantsBufferedReader = new BufferedReader(new InputStreamReader(new FileInputStream("C:\\Users\\andre\\Downloads\\DIANS_Domasna1\\DIANS_Domasna1\\Domashna1\\src\\main\\resources\\filtered_data.csv")));
        BufferedReader barsBufferedReader = new BufferedReader(new InputStreamReader(new FileInputStream("C:\\Users\\andre\\Downloads\\DIANS_Domasna1\\DIANS_Domasna1\\Domashna1\\src\\main\\resources\\filtered_data.csv")));
        BufferedReader cafesBufferedReader = new BufferedReader(new InputStreamReader(new FileInputStream("C:\\Users\\andre\\Downloads\\DIANS_Domasna1\\DIANS_Domasna1\\Domashna1\\src\\main\\resources\\filtered_data.csv")));
